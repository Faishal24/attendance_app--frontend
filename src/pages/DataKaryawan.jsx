      ...
      {selectedEmployee ? (
        <div className="p-5 flex flex-col gap-5">
          ...
          <table className="border-collapse border-none">
            <tbody>
              <tr>
                <td className="border px-4 py-2 font-bold border-none">Kode Karyawan</td>
                <td className="border px-4 py-2 font-bold border-none">:</td>
                <td className="border px-4 py-2 border-none">{selectedEmployee.kode}</td>
              </tr>
              <tr>
                <td className="border px-4 py-2 font-bold border-none">Nama</td>
                <td className="border px-4 py-2 font-bold border-none">:</td>
                <td className="border px-4 py-2 border-none">{selectedEmployee.name}</td>
              </tr>
              <tr>
                <td className="border px-4 py-2 font-bold border-none">Posisi</td>
                <td className="border px-4 py-2 font-bold border-none">:</td>
                <td className="border px-4 py-2 border-none">{selectedEmployee.posisi}</td>
              </tr>
              <tr>
                <td className="border px-4 py-2 font-bold border-none">Email</td>
                <td className="border px-4 py-2 font-bold border-none">:</td>
                <td className="border px-4 py-2 border-none">{selectedEmployee.email}</td>
              </tr>
              <tr>
        ...
        <p className="mt-[14em] text-2xl text-center font-bold">Data karyawan tidak tersedia</p>
      )}
    </Box>
  );
